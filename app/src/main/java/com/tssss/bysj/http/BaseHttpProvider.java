...
public abstract class BaseHttpProvider {
    ...
    public abstract void requestAsyncGet(String url, Map<String, ?> param, IHttpCallback callback);

    public abstract void requestPost(String url, Map<String, ?> param, IHttpCallback callback);
}
