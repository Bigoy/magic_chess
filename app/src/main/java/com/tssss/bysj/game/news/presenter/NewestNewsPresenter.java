...
public class NewestNewsPresenter extends BaseMvpPresenter<INewsNewestContract.IVew>
        implements INewsNewestContract.IPresenter {

    private boolean cancelLoadNews;
    private Handler handler;

    public NewestNewsPresenter(INewsNewestContract.IVew view) {
        super(view);
        handler = new Handler();
    }
    ...
    public void loadNews() {
        ...
        OkHttpProvider.getInstance().requestAsyncGet(HttpUrl.URL_NEWS_NEWEST, paraMap, new IHttpCallback() {
            @Override
    ...
    @Override
    protected INewsNewestContract.IVew getEmptyView() {
        return INewsNewestContract.emptyView;
    }
}
