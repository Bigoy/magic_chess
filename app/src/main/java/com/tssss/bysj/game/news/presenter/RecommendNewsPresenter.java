...
public class RecommendNewsPresenter extends BaseMvpPresenter<INewsRecommendContract.IVew>
        implements INewsRecommendContract.IPresenter {

    private boolean cancelLoadNews;
    private Handler handler;

    public RecommendNewsPresenter(INewsRecommendContract.IVew view) {
        super(view);
        handler = new Handler();
    }
    ...
    @Override
    protected INewsRecommendContract.IVew getEmptyView() {
        return INewsRecommendContract.emptyView;
    }
    ...
    public void loadNews() {
        ...
        OkHttpProvider.getInstance().requestAsyncGet(HttpUrl.URL_NEWS_RECOMMEND, paraMap, new IHttpCallback() {
            @Override
