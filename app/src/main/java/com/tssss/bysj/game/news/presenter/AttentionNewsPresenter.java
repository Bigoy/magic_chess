...
public class AttentionNewsPresenter extends BaseMvpPresenter<INewsAttentionContract.IVew>
        implements INewsAttentionContract.IPresenter {

    private boolean cancelLoadNews;
    private Handler handler;

    public AttentionNewsPresenter(INewsAttentionContract.IVew view) {
        super(view);
        handler = new Handler();
    }
    ...
    @Override
    protected INewsAttentionContract.IVew getEmptyView() {
        return INewsAttentionContract.emptyView;
    }
